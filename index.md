...
<div style="display: flex; justify-content: space-around; text-align: center; flex-wrap: wrap;">
  <div style="margin: 10px;">
    <img src="assets/img/smriti.jpg" alt="Pullabhatla Smriti" style="width: 120px; height: 120px; object-fit: cover; border-radius: 15px;">
    <p style="margin-top: 10px; font-size: 18px;">Pullabhatla Smriti</p>
  </div>
  <div style="margin: 10px;">
    <img src="assets/img/peli.jpg" alt="Peijing Li" style="width: 120px; height: 120px; object-fit: cover; border-radius: 15px;">
    <p style="margin-top: 10px; font-size: 18px;">Peijing Li</p>
  </div>
  <div style="margin: 10px;">
    <img src="assets/img/vyom_garg.jpg" alt="Vyom Garg" style="width: 120px; height: 120px; object-fit: cover; border-radius: 15px;">
    <p style="margin-top: 10px; font-size: 18px;">Vyom Garg</p>
  </div>
  <div style="margin: 10px;">
    <img src="assets/img/jake_cheng.png" alt="Jake Cheng" style="width: 120px; height: 120px; object-fit: cover; border-radius: 15px;">
